[车牌识别](https://github.com/ljgithub669/intellent-transportation/tree/master/Jie%20Li/recog_pic_video)主要分为两部分：一是车牌检测，使用深度学习，通过二值化、连通域检测、字符角点拟合、crop、sobel算子垂直分割；二是字符识别，用的是CNN神经网络，训练汉字和字母识别模型。
